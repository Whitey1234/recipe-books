...
const handleGooleLogin =()=>{
 ...
 console.log(result)
  ...
  <div className="card-body p-8">
    ...
    <p className="text-center text-sm opacity-75 mb-8">Sign in to your account</p>
    ...
    <fieldset className="space-y-4">
      ...
      <div className="form-control">
        <div className="flex justify-between items-center">
          ...
          <a className="label-text-alt link link-hover text-xs">Forgot password?</a>
        </div>
        <input 
          type="password" 
          className="input input-bordered w-full focus:ring-2 focus:ring-primary focus:border-transparent transition-all" 
      ...
      <button  type='submit' className="btn btn-primary w-full mt-6 hover:scale-[1.01] active:scale-[0.99] transition-transform">
        Login
    ...
    <p className="text-center text-sm mt-6">
      Don't have an account? <Link to={"/register"} className='link link-primary font-medium'> Sign up </Link>
    </p>
  </div>
</div>
        </form>
